...
const createJobPosting = async (req, res) => {
    const { employer, company, jobTitle, location, jobType, salary, details, noDegreeMentioned, benefits, applicants } = req.body;
...
const updateJobPosting = async (req, res) => {
    const { id } = req.params
    const { employer, company, applicants, jobTitle, location, salary, jobType, details, noDegreeMentioned, benefits } = req.body;
    ...
    const updatedJobPosting = { employer, company, applicants, jobTitle, salary, location, jobType, details, noDegreeMentioned, benefits, _id: id };
